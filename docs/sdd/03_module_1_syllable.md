...
| AudioPlayer        | Reusable audio playback component using Web Audio API. Accepts an audioUrl prop from Local static asset directories (Spring Boot). Shows retry button on playback failure.                                                                             | React Functional Component (.jsx) |
...
| **Component Name** | **Description and Purpose**                                                                                                                                                                                          | **Component Type / Format**       |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- |
| PakingganGame      | Loads syllable audio from Local static asset directories (Spring Boot), renders OptionGrid with 4 written syllable options. Handles selection result, records accuracy, and advances set on 3/4 correct. Requires Pagsama sub-level is complete. | React Functional Component (.jsx) |
| AudioPlayer        | Plays the target syllable audio from Local static asset directories (Spring Boot) URL. Retry button on failure.                                                                                                                                  | React Functional Component (.jsx) |
...
| **Component Name** | **Description and Purpose**                                                                                                                                                   | **Component Type / Format**       |
| ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- |
| KilalanGame        | Loads word audio from Local static asset directories (Spring Boot). Renders OptionGrid with 4 starting-syllable choices. Handles selection and accuracy recording. Requires Pakinggan sub-level complete. | React Functional Component (.jsx) |
