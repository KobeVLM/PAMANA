...
public class SentenceControllerTest {
        ...
        public void testSentenceTaskFlow() throws Exception {
                ...
                SentenceProgressRequest incorrectReq = new SentenceProgressRequest(taskId,
                                Arrays.asList("si", "Ako", "Lolo"));
                ...
                SentenceProgressRequest correctReq = new SentenceProgressRequest(taskId,
                                Arrays.asList("Ako", "si", "Lolo"));
                mockMvc.perform(post("/api/sentences/progress")
                                .header("Authorization", "Bearer " + token)
                                .contentType(MediaType.APPLICATION_JSON)
        ...
        public void testClassroomLeaderboardAndDashboardAndPdfReport() throws Exception {
                ...
                // 5. Explicitly complete Module 1 for the user and check PDF Report Download
                // API
                ...
                // Assert that an audit log row is successfully inserted in the reports log
                // table
